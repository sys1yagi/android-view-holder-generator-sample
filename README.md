...
A layout XML file will generates:
...
public final class FragmentMainViewHolder {
    ...
    /**
     * Same as <code>.from(context, viewGroup)</code> method but does nothing if <code>convertView</code> is supplied. It is designed to be used in <code>ListAdapter#getView()</code>.
     *
     */
